...
#os.curdir referencia o projeto que estou executando no terminal
...
if action == '1':
    if len(Password.get()) == 0:
        ...
        if path:
            print('Chave salva no arquivo, lembre-se de remover o aqrquivo após o transferir de local')
